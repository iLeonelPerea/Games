...
namespace Zuma
{
    ...
    /// </summary>
    public class Game5 : Microsoft.Xna.Framework.Game
    {
        //Atributos
        ...
        public void ChecaColision()
        {
            ...
            for (int i = 0; i < listaCamino.Count; i++)
            {
                ...
                Rectangle bolaRect = new Rectangle((int)bola.posicion.X, (int)bola.posicion.Y, spriteBola.Width, spriteBola.Height);
            ...
            Rectangle bolaRect1 = new Rectangle((int)primera.posicion.X, (int)primera.posicion.Y, spriteBola.Width, spriteBola.Height);
