...
namespace BattleFieldX
{
    ...
    public class Pausa : Escena
    {
        ...
        public Pausa(Game game, SpriteFont fuenteNormal, SpriteFont fuenteSeleccionada, Texture2D fondo)
            : base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(fondo, new Rectangle(0, 0, Game.Window.ClientBounds.Width, Game.Window.ClientBounds.Height), Color.Blue);
            spriteBatch.DrawString(fuenteNormal,"P  A  U  S  A" , new Vector2(200, 350), Color.Red);
            base.Draw(gameTime);
        }
    }
}