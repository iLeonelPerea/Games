...
namespace BattleFieldX
{
   ...
   //     protected AudioComponent audioComponent;
        ...
        public EscenaIntro(Game game,SpriteFont fuenteNormal, SpriteFont fuenteSeleccionada, Texture2D fondo)
            : base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(fondo,new Rectangle(0,0,Game.Window.ClientBounds.Width,Game.Window.ClientBounds.Height),Color.Yellow);
            base.Draw(gameTime);
        }
    }
}