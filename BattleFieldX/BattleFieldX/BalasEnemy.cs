...
namespace BattleFieldX
{
    ...
    /// </summary>
    public class BalasEnemy : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        private float x, y;
        private int px, py;
        public BalasEnemy(Game game, ref Texture2D textura, float x, float y, int px, int py)
            : base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            sBatch.Draw(textura, posicion, Color.Red);
            base.Draw(gameTime);
        }
