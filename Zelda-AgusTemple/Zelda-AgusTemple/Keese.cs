...
namespace Zelda_AgusTemple
{
    ...
    /// </summary>
    public class Keese : Microsoft.Xna.Framework.DrawableGameComponent
    {
        Texture2D textura1, textura2, actual;
        Vector2 pos, posL;
        int contador, contador1;
        public Keese(Game game, int x, int y)
            : base(game)
        {
            textura1 = Game.Content.Load<Texture2D>("Enemigos/Keese/Keese1");
            textura2 = Game.Content.Load<Texture2D>("Enemigos/Keese/Keese2");
            actual = textura1;
            contador = 0;
            contador1 = 0;
            pos = new Vector2(x, y);
        ...
        {
            return new Rectangle((int)(pos.X), (int)(pos.Y), 32, 20);
        }
